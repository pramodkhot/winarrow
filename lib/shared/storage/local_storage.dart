...
class LocalStorage {
  ...
  static bool get vibrationsEnabled => _prefs?.getBool('vibrations_enabled')    ?? true;
  static bool get darkMode          => _prefs?.getBool('dark_mode')             ?? false;
  static bool get adsRemoved        => _prefs?.getBool('ads_removed')           ?? false;

  static Future<void> setCurrentLevel(int v)      => _prefs!.setInt('current_level', v);
  static Future<void> setSoundsEnabled(bool v)    => _prefs!.setBool('sounds_enabled', v);
  static Future<void> setVibrationsEnabled(bool v)=> _prefs!.setBool('vibrations_enabled', v);
  static Future<void> setDarkMode(bool v)         => _prefs!.setBool('dark_mode', v);
  static Future<void> setAdsRemoved(bool v)       => _prefs!.setBool('ads_removed', v);
